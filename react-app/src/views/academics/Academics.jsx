...
const academicLinks = [
  { title: "MBBS Program", desc: "54 months of academic training plus a 12-month CRMI internship, taught in English.", image: images.classrooms[0], to: "/mbbs-program" },
      ...
      <section className="section">
        <div className="container split">
          <div data-animate="fade-left">
            ...
            <Link to="/mbbs-program" className="btn btn--primary" style={{ marginTop: "1.4rem" }}>
