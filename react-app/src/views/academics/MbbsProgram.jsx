  ...
  return (
    <>
      ...
      <InnerPageHero
        ...
        trail={[{ label: "Academics", path: "/mbbs-program" }]}
      ...
      <section className="section">
        <div className="container">
          ...
          <div style={{ textAlign: "center", marginTop: "2rem" }}>
            <Link to="/detailed-syllabus" className="btn btn--outline">
      ...
      <section className="section">
        <div className="container split">
          <div data-animate="fade-left">
            ...
            <Link to="/laboratories" className="btn btn--outline" style={{ marginTop: "1.2rem" }}>
      ...
      <section className="section">
        <div className="container split split--reverse">
          <div data-animate="fade-right">
            ...
            <Link to="/life-for-indian-students" className="btn btn--outline" style={{ marginTop: "1.2rem" }}>
