      ...
      <section className="section" style={{ background: "var(--gray-50)" }}>
        <div className="container">
          ...
          <div style={{ textAlign: "center", marginTop: "2.5rem" }}>
            <Link to="/admission-process" className="btn btn--primary btn--lg">
        ...
        <div className="container">
          ...
          <div className="card-grid card-grid--3" style={{ alignItems: "stretch" }}>
            <div className="feature-card" style={{ textAlign: "left" }} data-animate="fade-up">
              ...
              <Link to="/prospectus" className="btn btn--outline" style={{ marginTop: "1.2rem" }}>
                View Prospectus
              </Link>
            </div>
            <div className="feature-card" style={{ textAlign: "left" }} data-animate="fade-up" data-delay="90">
              ...
              <Link to="/tuition-fees" className="btn btn--outline" style={{ marginTop: "1.2rem" }}>
                View Fees Structure
              </Link>
            </div>
            <div className="feature-card" style={{ textAlign: "left" }} data-animate="fade-up" data-delay="160">
              ...
              <Link to="/scholarships" className="btn btn--outline" style={{ marginTop: "1.2rem" }}>
