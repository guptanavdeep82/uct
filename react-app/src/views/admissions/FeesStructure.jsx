  ...
  return (
    <>
      ...
      <InnerPageHero
        ...
        trail={[{ label: "Admissions", path: "/admission" }]}
      ...
      <section className="section">
        <div className="container">
          ...
          <div className="notice-banner" data-animate="fade-up">
            ...
            <Link to="/admission-enquiry">Admissions Office</Link> for the active intake.
          </div>
        </div>
      </section>
      ...
      <section className="section">
        <div className="container split">
          ...
          <div data-animate="fade-right" className="feature-card" style={{ textAlign: "left" }}>
            ...
            <Link to="/admission-enquiry" className="btn btn--outline" style={{ marginTop: "1.2rem" }}>
      ...
      <CTASection secondary={{ label: "Explore Scholarships", to: "/scholarships" }} />
    </>
  );
}
