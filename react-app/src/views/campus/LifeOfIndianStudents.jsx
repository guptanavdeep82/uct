    ...
    <>
      ...
      <section className="section" style={{ background: "var(--gray-50)" }}>
        <div className="container">
          ...
          <div className="about-explore">
            <Link to="/hostel-amp-student-housing" className="about-explore__card" data-animate="fade-up">
            ...
            <Link to="/facilities-amp-amenities" className="about-explore__card" data-animate="fade-up" data-delay={90}>
              <div className="about-explore__media">
            ...
            <Link to="/sports-amp-extracurriculars" className="about-explore__card" data-animate="fade-up" data-delay={180}>
              <div className="about-explore__media">
