...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/about-us/message-from-vice-prime-minister", destination: "/overview/", permanent: true },
      { source: "/the-vice-prime-minister", destination: "/overview/", permanent: false },
      ...
      { source: "/academics/faculty", destination: "/mbbs-program/", permanent: true },
      { source: "/faculty", destination: "/mbbs-program/", permanent: false },
